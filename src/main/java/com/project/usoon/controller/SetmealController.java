...
public class SetmealController {
    ...
    public R<String> save(@RequestBody SetmealDto setmealDto) {
        ...
        return R.success("Insert meal successfully");
    }
    ...
    public R<String> delete(@RequestParam List<Long> ids) {
        ...
        return R.success("Delete meal successfully");
    }
    ...
    public R<String> status(@PathVariable String status, @RequestParam List<Long> ids) {
        ...
        return R.success("Update status of meal successfully");
    }
    ...
    @GetMapping("/dish/{id}")
    public R<List<DishDto>> showSetmeal(@PathVariable Long id) {
        LambdaQueryWrapper<SetmealDish> queryWrapper = new LambdaQueryWrapper<>();
        queryWrapper.eq(SetmealDish::getSetmealId, id);
